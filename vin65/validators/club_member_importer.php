...
<?php
  ...
  require_once $_ENV['APP_ROOT'] . "/vin65/validators/club_member_importer.php";

  use \wgm\vin65\validators\ClubMemberImporter as ClubMemberImporter;

  $validator = new ClubMemberImporter($db);
...
<body>
  <div class="container">
    ...
    <?php
      if( $validator->getState()==ClubMemberImporter::STATE_TESTS_COMPLETE ){
