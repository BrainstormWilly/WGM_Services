<?php namespace wgm\vin65\controllers;
  ...
  class SearchClubMemberships extends AbstractSoapController{
    ...
    function __construct($session){
      ...
      $this->_input_form = new ServiceInputForm( new SearchClubMembershipsModel($session) );
    }
    ...
    public function getFullResultsTable(){
      ...
      if( isset($model) ){
        ...
        if( !empty($res) ){
          ...
          foreach ($res->ClubMemberships as $value) {
            $r .= "<tr>" .
                  "<td>" . $value->ClubMembershipID . "</td>" .
