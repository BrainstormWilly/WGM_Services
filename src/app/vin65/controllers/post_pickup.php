<?php namespace wgm\vin65\controllers;
  ...
  class PostPickup extends AbstractSoapController{

    function __construct($session){
      parent::__construct($session);

      $this->_queue->appendService( "wgm\\vin65\\models\\PostPickup" );
      $this->_input_form = new ServiceInputForm( new PostPickupModel($session) );
    }
    ...
    public function inputRecord($record){
      ...
      $this->_queue->init($_ENV['UPLOADS_PATH'] . '/post_pickup.csv');
    }
